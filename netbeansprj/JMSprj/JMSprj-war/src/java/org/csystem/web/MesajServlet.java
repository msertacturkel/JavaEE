 ...
 */
@WebServlet(name = "MesajServlet", urlPatterns = {"/MesajServlet"})
public class MesajServlet extends HttpServlet {
    ...
    sendJMSMessageToMsg("test");
    try {
        /* TODO output your page here. You may use following sample code. */
        out.println("<!DOCTYPE html>");
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Servlet MesajServlet</title>");            
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Servlet MesajServlet at " + request.getContextPath() + "</h1>");
        out.println("</body>");
        out.println("</html>");
    } finally {            
        out.close();
            ...
            Logger.getLogger(MesajServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
