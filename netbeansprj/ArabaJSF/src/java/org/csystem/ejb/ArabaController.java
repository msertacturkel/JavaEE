...
public class ArabaController implements Serializable {
    ...
    @EJB
    private org.csystem.ejb.ArabaFacade ejbFacade;
    ...
    public static class ArabaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Araba) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Araba.class.getName());
            }
        }
    }
}
