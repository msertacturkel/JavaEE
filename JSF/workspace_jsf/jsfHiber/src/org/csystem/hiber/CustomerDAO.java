...
public class CustomerDAO extends BaseHibernateDAO  {
    ...
    public Customer findById( java.lang.Integer id) {
        ...
        try {
            Customer instance = (Customer) getSession()
                    .get("org.csystem.hiber.Customer", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List findByContactfýrstname(Object contactfýrstname
	) {
	...
	public List findByAddresslýne1(Object addresslýne1
	) {
		return findByProperty(ADDRESSLINE1, addresslýne1
		);
	}
	
	public List findByAddresslýne2(Object addresslýne2
	) {
		return findByProperty(ADDRESSLINE2, addresslýne2
		);
	}
	
	public List findByCýty(Object cýty
	) {
	...
	public List findByCredýtlýmýt(Object credýtlýmýt
	) {
